process.stdout.write("]2;WHITE V3 🌐 Ultra Edition\\");
...
const titles = [["██╗    ██╗██╗  ██╗██╗████████╗███████╗    ██╗   ██╗██████╗ ", "██║    ██║██║  ██║██║╚══██╔══╝██╔════╝    ██║   ██║╚════██╗", "██║ █╗ ██║███████║██║   ██║   █████╗      ██║   ██║ █████╔╝", "██║███╗██║██╔══██║██║   ██║   ██╔══╝      ╚██╗ ██╔╝ ╚═══██╗", "╚███╔███╔╝██║  ██║██║   ██║   ███████╗     ╚████╔╝ ██████╔╝", " ╚══╝╚══╝ ╚═╝  ╚═╝╚═╝   ╚═╝   ╚══════╝     ╚═══╝  ╚═════╝ "], ["█░█░█ █░█ █ ▀█▀ █▀▀    ▀█", "▀▄▀▄▀ █▀█ █ ░█░ ██▄    █▄"], ["W H I T E  V 3 @" + currentVersion], ["WHITE V3"]];
...
let subTitle = "WHITE V3@" + currentVersion + "- Powered by DJAMEL";
const subTitleArray = [];
...
async function startBot(_0x3cad9e) {
  ...
  log.warn("FCA", "Modified By DJAMEL 😈");
  try {
  ...
  (function _0x3592ba(_0x812929) {
    ...
    login({
      ...
      console.log(chalk.bold.yellowBright("  ©  ") + chalk.cyanBright("WHITE V3") + chalk.white(" created by ") + chalk.bold.greenBright("DJAMEL") + chalk.gray(" (https://github.com/castrolmocro)") + chalk.white(" — do not sell or claim as your own."));
      logColor("#f5ab00", character);
